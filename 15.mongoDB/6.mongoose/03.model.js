...
// 根据id找
/*StuModel.findById("5f92d4afa201364b6ca466cf" , function (err , doc) {
	if(!err){
		console.log(doc);
...
//修改唐僧的年龄为20
/*StuModel.updateOne({name:"沙和尚"},{$set:{age:20}},function (err) {
	if(!err){
		console.log("修改成功");
	}
});*/
 ...
 */
/*StuModel.deleteMany({name:"白骨精"},function (err) {
	if(!err){
		console.log("删除成功~~");
	}
});*/
